/*
  ...
  - You are about to drop the column `corseId` on the `CourseToPrerequisite` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "CourseToPrerequisite" DROP CONSTRAINT "CourseToPrerequisite_corseId_fkey";
